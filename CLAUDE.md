# CLAUDE.md — AI Engineer Learning Project
...
We build one real system together. Claude coaches; Joey drives. Shipping working code is
...
**Decision protocol** — at every significant fork, Claude posts:
...
Before each new subsystem, Claude gives a short explainer — what it is, why it exists,
...
**Decided:**
- **Generation LLM:** Anthropic Claude — `claude-sonnet-5` workhorse, `claude-haiku-4-5`
  for bulk ops, `claude-opus-5` for occasional quality comparison only
